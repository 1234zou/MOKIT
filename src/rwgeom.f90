...
! Note: only basis set data of adjacent atoms will be merged. e.g. the 4th and
...
!f2py intent(in) :: gjfname
 type :: molecule_map
  ...
  integer :: nadj = 0  ! No. of adjacent molecules within dis_thres
...
!f2py intent(out) :: conformer
 ...
 ! Now the eigenvalues are almost identical. But some cases cannot be identified,
