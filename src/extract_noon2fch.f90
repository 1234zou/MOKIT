...
program main
 ...
 if(i<4 .or. i>6) then
  ...
  write(iout,'(/,A)') ' Example1(PySCF CASCI): extract_noon_2fch a.out a.fch 19 24'
  write(iout,'(/,A)') ' Example2 (GAMESS GVB): extract_noon_2fch a.dat a.fch 19 24 0'
  write(iout,'(/,A)') ' Example3 (GAMESS GVB): extract_noon_2fch a.dat a.fch 19 24 0 -gau'
  stop
 end if
